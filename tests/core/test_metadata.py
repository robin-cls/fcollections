    ...
    return GroupMetadata(
        ...
        subgroups=[
            GroupMetadata('group1',
                          variables=[
                              VariableMetadata('var1', np.float64, ('x', ),
                                               dict(comment='a random var')),
                              VariableMetadata(
                                  'var2', np.int32, ('x', 'y'),
                                  dict(comment='another random var'))
                          ],
                          attributes={},
...
def test_render(flattened: dict[str, tp.Any]):
    ...
    names = [
        'Group: /', 'Dimensions', 'Variables', 'Attributes', 'Group: /group1',
        'Dimensions', 'Variables', 'var1', 'var2', 'Attributes'
    ]
...
def test_nodes(nested_groups: GroupMetadata):
    expected = [
        nested_groups, nested_groups.subgroups[0],
