...
@pytest.mark.parametrize('convention, array, expected_arr', [
    ((-180, 180), [0, 1], [[0, 1]]),
    ((0, 360), [0, 1], [[0, 1]]),
    ((-180, 180), [-180, -100, 0, 1, 180], [[-180, -100, 0, 1, 180]]),
...
@pytest.mark.parametrize('lon_array, expected_convention', [
...
@pytest.mark.parametrize('lon_array', [([-12, 0, 3, 100, 250]),
                                       ([0, 360, 1, 10, 2, 400]),
                                       ([-181, 0, 1, 10, 20]),
