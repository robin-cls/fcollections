...
def test_mission_phases():
    assert {e.name
            for e in MissionsPhases} == {
                'al', 'alg', 'cfo', 'c2', 'c2n', 'e1g', 'e1', 'e2', 'en',
                'enn', 'g2', 'h2ag', 'h2a', 'h2b', 'h2c', 'j1', 'j1g', 'j1n',
                'j2', 'j2g', 'j2n', 'j3', 'j3n', 'j3g', 's3a', 's3b', 's6a',
                's6a_lr', 's6a_hr', 'swon', 'swonc', 'swot', 'calval',
                'science', 'tp', 'tpn'
            }
