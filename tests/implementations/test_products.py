...
def test_from_bytes_array():
    expected = [[L2Version(), L2Version(Timeliness.G, 'B', 1, 2)],
                [L2Version(Timeliness.I, 'A', 0, 1),
                 L2Version(baseline='B')]]
...
@pytest.mark.parametrize('version, is_null', [
...
@pytest.mark.parametrize('bad_version',
                         ['PIC0_0', 'PXC0_01', 'AIC0_01', 'PI11_01'])
...
@pytest.mark.parametrize(
    ...
    ids=[
        'better_temporality', 'lesser_product_counter', 'higher_minor_version',
        'lesser_baseline', 'equality'
    ])
def test_ordering(v1: str, v2: str, expected: tuple[bool, bool, bool, bool,
                                                    bool]):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (np.array([['PIC0_01', 'None', 'PIC0_02', 'PIB1_01'],
        ...
        (np.array([['PIC0_01', 'None', 'PIC0_02', 'PIB1_01'],
                   [None, 'None', 'PID0_02', 'PIB1_01']]), '<',
         np.array([[L2Version.from_string('PIC0_01')] * 4,
...
def test_array_comparison(input_array, cmp_operator, cmp_right_member,
                          cmp_res):
    ...
    assert_array_equal(ops_map[cmp_operator](versions, cmp_right_member),
                       cmp_res)
