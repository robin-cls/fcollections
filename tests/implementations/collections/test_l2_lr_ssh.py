...
class TestVersionField:
    ...
    @pytest.mark.parametrize('input, sanitized', [
        (L2Version(Timeliness.G, 'C', 0, 1), L2Version(Timeliness.G, 'C', 0,
                                                       1)),
    ...
    def test_version_field_sanitize(self, input: str | L2Version,
                                    sanitized: L2Version):
...
class TestReader:
    ...
    def setup(self):
        try:
            ...
            from fcollections.implementations.optional import GeoSwotReaderL2LRSSH
    ...
    def test_all_multi_read_non_stack(self, files: list[str],
    ...
    @pytest.mark.parametrize(
        ...
        [('l2_lr_ssh_basic_files_unique', ProductSubset.Basic, [(482, 11),
                                                                (482, 12),
                                                                (482, 25),
                                                                (482, 26),
                                                                (483, 25),
                                                                (483, 26),
                                                                (546, 11)]),
         ('l2_lr_ssh_expert_files_unique', ProductSubset.Expert, [(6, 11),
                                                                  (6, 532),
                                                                  (6, 533),
                                                                  (7, 532),
                                                                  (7, 533),
    ...
    def test_expert_multi_read_stack_cycles_passes(
            self, files: list[list[str]], subset: ProductSubset,
            expected_half_orbits: list[int,
                                       int], request: pytest.FixtureRequest):
    ...
    def test_expert_bbox(self, files: str, stack: StackLevel,
                         request: pytest.FixtureRequest):
        pass_number = 25
    ...
    def test_expert_selected_variables(self,
                                       l2_lr_ssh_expert_files: list[str]):
    ...
    def test_unsmoothed_read(self, l2_lr_ssh_unsmoothed_files: list[str],
                             l2_lr_ssh_unsmoothed_dataset: xr.Dataset):
        ds = self.reader.read(ProductSubset.Unsmoothed,
                              l2_lr_ssh_unsmoothed_files[:1],
                              left_swath=True,
                              right_swath=False).compute()
        xr.testing.assert_equal(ds.drop_vars(['cycle_number', 'pass_number']),
    ...
    def test_unsmoothed_read_complete_swath(
        ...
        reference = self.reader.read(ProductSubset.Unsmoothed,
    ...
    def test_unsmoothed_read_nothing(self,
    ...
    def test_metadata(self, l2_lr_ssh_unsmoothed_files: list[str]):
        ...
        # method
        metadata = self.reader.metadata(l2_lr_ssh_unsmoothed_files[0],
                                        fs_loc.LocalFileSystem())
...
class TestListing:
    ...
    @pytest.mark.parametrize('query, half_orbits', [
        ({}, [(577, 18), (546, 11), (546, 18), (577, 11), (577, 18), (6, 11),
              (6, 532), (6, 533), (7, 532), (7, 533), (482, 11), (482, 12),
              (482, 25), (482, 26), (483, 25), (483, 26), (546, 18), (546, 18),
              (10, 4)]),
        ({
            'cycle_number': [577]
        }, [(577, 18), (577, 11), (577, 18)]),
        ({
            'pass_number': [11]
        }, [(546, 11), (577, 11), (6, 11), (482, 11)]),
        ({
            'time': (np.datetime64('2023-06-08'), np.datetime64('2023-06-09'))
        }, [(546, 11)]),
        ({
            'subset': ProductSubset.Basic
        }, [(546, 11), (482, 11), (482, 12), (482, 25), (482, 26), (483, 25),
            (483, 26)]),
        ({
            'subset': ProductSubset.Unsmoothed
        }, [(10, 4)]),
        ({
            'version': L2Version(baseline='A')
        }, [(577, 18)]),
    ])
    def test_list(self, l2_lr_ssh_dir_empty_files: Path,
    ...
    @pytest.mark.with_geo_packages
    def test_list_bbox_global(self, l2_lr_ssh_dir_empty_files: Path,
    ...
    @pytest.mark.with_geo_packages
    def test_list_bbox(self, l2_lr_ssh_dir_empty_files: Path, pass_number: int,
    ...
    def test_list_deduplicate(self, l2_lr_ssh_dir_empty_files: Path):
        ...
        files = db.list_files(deduplicate=True,
                              unmix=True,
                              sort=True,
                              subset='Expert')
        ...
        assert sorted(half_orbits_no_duplicates) == sorted(
            set(half_orbits_duplicates))
    ...
    def test_list_deduplicate_autopick(self, l2_lr_ssh_dir_empty_files: Path):
        ...
        assert {str(x)
                for x in files_metadata['version']} == {'PIA2_02', 'PIB0_01'}

        # Autopick version
        files_metadata = db.list_files(cycle_number=577,
                                       pass_number=18,
                                       deduplicate=True)
...
class TestLayout:
    ...
    def test_list_swot_lr_l2_layout(self,
        ...
        db_no_layout = NetcdfFilesDatabaseSwotLRL2(
