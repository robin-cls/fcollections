...
@pytest.mark.parametrize('db, keywords', [
    ('swot_lr_l2_db', [
        'List the files matching the given criteria.', 'sort', 'cycle_number',
        'pass_number', 'time', 'level', 'subset'
    ]),
    ('swot_lr_l3_db', [
        'List the files matching the given criteria.', 'sort', 'cycle_number',
        'pass_number', 'time', 'level', 'subset'
    ...
    ('nadir_db', [
        'List the files matching the given criteria.', 'sort', 'time',
        'mission'
    ]),
...
@pytest.mark.parametrize('db, keywords', [
    ('swot_lr_l2_db', [
        'Query a dataset by reading selected files in file system.', 'stack',
        'left_swath', 'selected_variables', 'cycle_number', 'pass_number',
        'time', 'level', 'subset', 'right_swath'
    ]),
    ('swot_lr_l3_db', [
        'Query a dataset by reading selected files in file system.', 'stack',
        'swath', 'nadir', 'selected_variables', 'cycle_number', 'pass_number',
        'time', 'level', 'subset'
    ]),
    ('nadir_db', [
        'Query a dataset by reading selected files in file system.',
        'selected_variables', 'time', 'mission'
    ]),
    ('sst_db', [
        'Query a dataset by reading selected files in file system.',
