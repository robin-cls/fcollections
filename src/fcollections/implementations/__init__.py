...
try:
    ...
    from .optional import \
        GeoNetcdfFilesDatabaseL2Nadir as NetcdfFilesDatabaseL2Nadir
    from .optional import \
        GeoNetcdfFilesDatabaseL3Nadir as NetcdfFilesDatabaseL3Nadir
    ...
    from .optional import \
        GeoNetcdfFilesDatabaseSwotLRL2 as NetcdfFilesDatabaseSwotLRL2
    from .optional import \
        GeoNetcdfFilesDatabaseSwotLRL3 as NetcdfFilesDatabaseSwotLRL3
    from .optional import \
        GeoNetcdfFilesDatabaseSwotLRWW as NetcdfFilesDatabaseSwotLRWW
